                    ...
                    <div class="col-lg-2">
                     ...
                     <div class="col-lg-10">
                        <div class="ht-widget">
							...
							<a href="login" class="layout-navigation-bar-login__item">로그인</a><span>&nbsp;|&nbsp;</span>
							<!-- 로그인 --> <!-- 로그인시 로그아웃 -->
							...
							<c:if test="${session_flag == 'success' }">
							<!-- if문 session값을 확인하여 메뉴를 달리해준다. -->
							<a href="loginOut" class="layout-navigation-bar-login__item">로그아웃</a><span>&nbsp;|&nbsp;</span>
							<!-- 로그인 --> <!-- 로그인시 로그아웃 -->
                    ...
                    <div class="col-lg-3">
                       <div class="hn-social">
							...
							<form action="">
								...
								<!-- 검색 -->
								<input class="fas fa-search fa-lg" id="searchButton" type="button" id="" onclick="" value="검색">
							</form>
						</div>
                    </div>
                </div>
							...
							<div class="keyImg">
								<div class="thumbnail">
									<a href="#none" alt="P00000CJ"> <img
										src="productImg/${productVo.product_Main }" style="width: 100%;"
										alt="상세페이지 BigImage" class="BigImage " />
									</a>
								</div>
							</div>
                        ...
                        <td class="social">  <ul module="product_customsns"><li></li></ul></td>
								...
								function QuantityUp(product_Number,product_Price) {
									...
									$.ajax({
										...
										success:function(data){  
											...
											html3 += '<a href="ProductOrder" id="btnBuy" class="first dj-btn-1  ">';
											html3 += '구매하기<img src="//img.echosting.cafe24.com/skin/base_ko_KR/product/btn_reserve.gif" alt="예약주문" class="displaynone" id="btnReserve" /></a>';
											html3 += '';
								...
								<table border="0" summary="">
									...
									<tbody class="productBox">
										<tr>
											...
											<input id="quantity1"name="quantity_opt[]" style="" value="1" type="text" />
											<a href="#none">
											 	<img src="//img.echosting.cafe24.com/skin/base_ko_KR/product/btn_count_up.gif" alt="수량증가" class="QuantityUp up" onclick="QuantityUp(${productVo.product_Number},${productVo.product_Price})"/></a>
											<a href="#none">
											 	<img src="//img.echosting.cafe24.com/skin/base_ko_KR/product/btn_count_down.gif" alt="수량감소" class="QuantityDown down" onclick="QuantityDown(${productVo.product_Number},${productVo.product_Price})" />
											</a>
											</span></td>
							...
							<div class="xans-element- xans-product xans-product-action" >
								<div class="ec-base-button" id="pay">
									<a href="ProductOrder" id="btnBuy" class="first dj-btn-1  ">
									구매하기<img src="//img.echosting.cafe24.com/skin/base_ko_KR/product/btn_reserve.gif" alt="예약주문" class="displaynone" id="btnReserve" /></a> 
									
									<a href="cartGo?product_Number=${productVo.product_Number }&s_id=${s_ID }" class="dj-btn-1-2 " >
									장바구니<img src="/_dj/img/infoArea_scroll_fixed_go_cart.png" alt="픽스장바구니아이콘" style="display: none" /></a>
									...
									<div class="board">
										<div class="ec-base-button typeBorder">
											<span class="gRight"> <a
												...
												href="/board/p_review/list.html?board_no=4" class="dj-btn-2">LIST</a>
											</span>
										</div>
