	...
	function openZipSearch() {
		...
		new daum.Postcode({
			oncomplete : function(data) {
				$("#f_postal1").val(data.zonecode);
				$("#l_postal2").val(data.address);
...
<body>
	...
	<div class="main_wrap">
		<section id="">
			<form action="ProductOrderOk" method="post">
				<!-- 전체 묵음 div -->
				<div>
					<!-- 배송지 테이블 -->
					<div class="h2_test">
							...
							<tr>
								<div>
									<span class="registraionLable">우편번호 : </span> <input value="${user_DetailsVo.user_Address1 }"
										type="text" id="f_postal1" placeholder="우편번호" name="user_Address1"
								...
								<div>
									<span class="registraionLable">도로명주소 : </span> <input value="${user_DetailsVo.user_Address2 }"
										type="text" id="l_postal2" placeholder="기본 주소"
								...
								<div>
									<span class="registraionLable">상세 주소 : </span> <input value="${user_DetailsVo.user_Address3 }"
										type="text" id="l_postal3" placeholder="상세 주소 "
								...
								<div>
									<span class="registraionLable">수령인 이름 : </span> <input value="${user_DetailsVo.user_Name }"
										type="text" id="l_postal4" placeholder="수령인 이름 "
										name="user_Name" style="width: 620px;"
										class="css_input_userInfo_email" />
								</div>
								<select name="other" id="travel_arriveVia"
							...
							<tr>
								<div>
									<span class="registraionLable">이 름 : </span> <input type="text" value="${user_DetailsVo.user_Name }"
										id="f_postal1" placeholder="이름" name="f_postal1"
								...
								<div>
									<span class="registraionLable">전화 번호 : </span> <input  value="${user_DetailsVo.user_Tel }"
										type="text" id="l_postal5" placeholder="전화 번호 "
					...
					<div class="OrderPay2">
						...
						<div style="margin-left: 50%;">
							<button type="submit" value="결제하기" class="css_input_btn">결제하기</button>
						</div>
					</div>
					<!-- 결제금액 테이블  끝-->
				</div>
